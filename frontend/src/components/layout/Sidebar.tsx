...
import {
    ...
    Bell, FileText, Settings, HelpCircle, Calendar, Video // <-- 1. Yahan Calendar aur Video icons import kiye hain
} from 'lucide-react';
...
export const Sidebar: React.FC = () => {
    ...
    const entrepreneurItems = [
        ...
        // 2. Entrepreneur k liye add kr diya:
    ...
    const investorItems = [
        ...
        { to: '/messages', icon: <MessageCircle size={20} />, text: 'Messages' },
        // 3. Investor k liye bhi add kr diya:
        { to: '/meetings', icon: <Calendar size={20} />, text: 'Meetings' },
        { to: '/video-call', icon: <Video size={20} />, text: 'Video Call' },
        { to: '/notifications', icon: <Bell size={20} />, text: 'Notifications' },
